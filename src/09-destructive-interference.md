...
**Fig. 6** (If no video displays then [view notebook in nbviewer](https://nbviewer.jupyter.org/github/project-ida/two-state-quantum-systems/blob/master/09-destrctive-interference.ipynb)) or run `Video("img/pendulum-destructive.mp4", embed=True)`
...
**Fig. 9** (If no video displays then [view notebook in nbviewer](https://nbviewer.jupyter.org/github/project-ida/two-state-quantum-systems/blob/master/09-destrctive-interference.ipynb)) or run `Video("img/pendulum-remove-destructive.mp4.mp4", embed=True)`
